...
public class EchartsDataVO {
    ...
    public List<Object> getXData() { return xData; }
    public void setXData(List<Object> xData) { this.xData = xData; }
    public List<Object> getYData() { return yData; }
    public void setYData(List<Object> yData) { this.yData = yData; }
